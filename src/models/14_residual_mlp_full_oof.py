...
FEATURE_PATH = os.path.join(INPUT_DIR, "14_residual_features_full.npz")
LABEL_PATH = os.path.join(INPUT_DIR, "14_residual_label_full.npz")
LOG_PATH = os.path.join(OUTPUT_DIR, "logs", "14_residual_mlp_full_oof.csv")
OOF_PATH = os.path.join(OUTPUT_DIR, "oof", "14_residual_mlp_full_oof.npz")
...
# 모델 구조
FEATURE_DIM = 14        # 각 subspace feature 차원 (변경 없음)
...
# Feature 구성 확인
print(f"\n📋 Feature 구성 (14 dims per subspace):")
print(f"   V1 Features: product_vec(8) | distance_l2(1) | centroid_mae(1) | centroid_var(1)")
print(f"   V2 Features: norm_l2_squared(1) | norm_l2_normalized(1) | subspace_target(1)")
