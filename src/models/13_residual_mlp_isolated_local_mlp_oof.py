...
LOG_PATH = os.path.join(OUTPUT_DIR, "logs", "13_residual_mlp_isolated_local_mlp_oof.csv")
OOF_PATH = os.path.join(OUTPUT_DIR, "oof", "13_residual_mlp_isolated_local_mlp_oof.npz")
...
# 모델 구조 출력 (한 번만)
temp_model = IsolatedLocalMLPPredictor()
print(temp_model)
