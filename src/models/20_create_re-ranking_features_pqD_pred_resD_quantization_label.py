...
NEW_LABEL_PATH = os.path.join(INPUT_DIR, "01_re-ranking_label.npz")  # 새로운 Label 파일

# 출력 파일
OUTPUT_FEATURE_PATH = os.path.join(INPUT_DIR, "21_re-ranking_pqD_pred_resD_label.npz")
