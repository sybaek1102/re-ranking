...
FEATURE_PATH = os.path.join(INPUT_DIR, "18_residual_features_resD_pq_opt_final.npz")
LABEL_PATH = os.path.join(INPUT_DIR, "15_residual_label_dot.npz")
LOG_PATH = os.path.join(OUTPUT_DIR, "logs", "18_residual_mlp_resD_pq_opt_final_dot_oof.csv")
OOF_PATH = os.path.join(OUTPUT_DIR, "oof", "18_residual_mlp_resD_pq_opt_final_dot_oof.npz")
...
print(f"   product_vec(8) | feat_res_dot(1)")
print(f"   Removed: distance_l2, centroid_mae, centroid_var, feat_res_sq, feat_res_sc")
