...
LOG_PATH = os.path.join(OUTPUT_DIR, "logs", "16_residual_mlp_resD_pq_no_cent_dot_oof.csv")
OOF_PATH = os.path.join(OUTPUT_DIR, "oof", "16_residual_mlp_resD_pq_no_cent_dot_oof.npz")
...
# 모델 구조
FEATURE_DIM = 12        # 각 subspace feature 차원 (변경 없음)
