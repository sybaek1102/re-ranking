...
OOF_PRED_PATH = os.path.join(OUTPUT_DIR, "oof", "12_residual_mlp_quantization_int4_norm_scaled_oof.npz")

# 출력 파일
OUTPUT_FEATURE_PATH = os.path.join(INPUT_DIR, "22_re-ranking_pqD_pred_resD_int4_norm_scaled.npz")
