...
# [수정] 로그 파일 경로 변경 (residual_only)
INPUT_PATH = os.path.join(INPUT_DIR, "03_re-ranking_features_pqD_residual.npz")
LOG_PATH = os.path.join(OUTPUT_DIR, "logs", "03_re-ranking_mlp_residual_only.csv")
...
# [수정] 단순화된 StandardScaler 적용 (Feature가 한 종류뿐이므로)
print("  >>> Scaling 적용 중...")
