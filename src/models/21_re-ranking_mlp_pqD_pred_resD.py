...
INPUT_PATH = os.path.join(INPUT_DIR, "03_re-ranking_features_pqD_residual_label.npz")
LOG_PATH = os.path.join(OUTPUT_DIR, "logs", "03_re-ranking_features_pqD_residual_label.csv")
