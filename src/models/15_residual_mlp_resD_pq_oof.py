...
FEATURE_PATH = os.path.join(INPUT_DIR, "15_residual_features_resD_pq_4bit.npz")
LABEL_PATH = os.path.join(INPUT_DIR, "15_residual_label_dot.npz")
LOG_PATH = os.path.join(OUTPUT_DIR, "logs", "15_residual_mlp_resD_pq_4bit_dot_oof.csv")
OOF_PATH = os.path.join(OUTPUT_DIR, "oof", "15_residual_mlp_resD_pq_4bit_dot_oof.npz")
