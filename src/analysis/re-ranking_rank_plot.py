...
OUTPUT_GRAPH_PATH = os.path.join(RESULTS_DIR, "re-ranking_rank.png")
...
# ============================================================
# 파일 1: 막대 그래프 (re-ranking_rank_bar.png)
# ============================================================
...
# 모든 막대 너비를 동일하게 설정
bar_width = 0.4  # log scale과 동일

# x축 데이터 준비
x_labels_log = bin_labels  # 10^1, 10^2, 10^3
...
# 막대 그래프 저장 (여백 수정)
# 기존 left=0.02는 Y축 글자가 들어가기에 너무 좁아서 0.05 정도로 늘렸습니다.
...
# bbox_inches='tight': 그래프 구성 요소(글자 포함)에 맞춰서 저장 영역을 자동으로 늘려주는 핵심 옵션입니다.
# pad_inches=0.1: 약간의 추가 여백을 줍니다.
...
# ============================================================
# 파일 2: 꺾은선 + CDF 그래프 (re-ranking_rank_line.png)
# ============================================================
