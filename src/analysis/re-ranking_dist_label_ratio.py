...
OOF_PATH = os.path.join(OUTPUT_DIR, "oof", "02_re-ranking_mlp_gtD_oof.npz")
SAVE_FIG_PATH = "/home/syback/vectorDB/re-ranking/results/analysis/re-ranking_gtD_label_ratio.png"
